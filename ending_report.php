		...
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<?
						HtmlCore::getMenu('ending_report');
					?>
				</section>
			</aside>
			...
			<div class="content-wrapper">
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">รายงานผลเดิมพัน</li>
					</ol>
				</section>
				...
				<section class="content" style="font-family: 'Kanit'">
					<?
                        ...
                        $date = date('Y-m-d');
                        $sql = "SELECT * FROM lotto_list INNER JOIN lotto ON lotto.lotto_id = lotto_list.lotto_id WHERE lotto_list.lotto_list_status=1 AND lotto_list.lotto_list_end<'".$now."' AND lotto_list.lotto_list_start<'".$now."' AND lotto_list_check=0";	
                        $lotto_data2 = $query->queryDB_to_array($sql);
								...
								<div class="box-body"> 
                                    <div class="box-body table-responsive ">
                                        <table class="table table-hover table-striped" id="data_table2">
                                            ...
                                            <tbody>
                                                <?
                                                    foreach($lotto_data2 as $key => $val){
