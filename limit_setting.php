			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<?
						...
						HtmlCore::getMenu('limit_setting');
...
function setAll(type){
	...
	if(parseFloat($('#'+type+'_all').val())>=0 && parseFloat($('#'+type+'_all').val())!=''){
