			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<?
						...
						HtmlCore::getMenu('share_setting');
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">ส่วนแบ่งหุ้น</li>
								...
								<form id="user_form" class="form-horizontal form-label-left">
									...
									<div class="box-body">
										...
										<div class="col-md-2 mt-1 pb-2 text-right">
											...
											<select class="form-control" id="share_copy">
...
$(function () {
	...
	$("#share_copy").change(function(event){

		$.ajax({

			type: "POST",

			url: "api/get_share_copy",
...
function setShare(i,id){
	...
	if(parseFloat($('#share_'+i).val())>=0){

		$('#keep_'+i).val( $('#owner_'+i).val() - $('#share_'+i).val() );
...
function setShares(i,id){

	if(parseFloat($('#share_'+i).val())>=0){

		var str = '';

		var min = parseFloat($('#owner_min'+i).val() - $('#share_'+i).val());

		var max = parseFloat($('#owner_max'+i).val() - $('#share_'+i).val());
